...
def crop_prediction():
    ...
    if request.method == 'POST':
        ...
        t2g = top_3.iloc[[2],[6]].values.tolist()[0][0]
        t2h = top_3.iloc[[2],[7]].values.tolist()[0][0]
        t2i = top_3.iloc[[2],[8]].values.tolist()[0][0]
        t2j = top_3.iloc[[2],[9]].values.tolist()[0][0]
        t2k = top_3.iloc[[2],[10]].values.tolist()[0][0]
